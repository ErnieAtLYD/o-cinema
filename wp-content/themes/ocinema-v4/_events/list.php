...
<div id="tribe-events-content" class="upcoming">
	...
	<?php while ( have_posts() ) : the_post(); ?>
		...
		<div id="post-<?php the_ID() ?>" <?php post_class('tribe-events-event clearfix') ?> itemscope itemtype="http://schema.org/Event">
			...
			<h2 class="entry-title" itemprop="name"><a href="<?php echo tribe_get_event_link(); ?>" title="'<?php echo the_title_attribute('echo=0'); ?>" rel="bookmark"><?php echo get_the_title(); ?> (<?php echo tribe_get_city(); echo ', '; echo tribe_get_region(); ?>)</a></h2>
